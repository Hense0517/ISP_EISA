...
$nonAdminTablesArr[] = "numeros_de_cables";
$nonAdminTablesArr[] = "numeros_de_spliters";
$nonAdminTablesArr[] = "ctos";
$nonAdminTablesArr[] = "localidad";
$nonAdminTablesArr[] = "cables";
$nonAdminTablesArr[] = "spliters";
$nonAdminTablesArr[] = "numeros_cto";
$nonAdminTablesArr[] = "numero_puertos";
$nonAdminTablesArr[] = "puertos_cto";
$nonAdminTablesArr[] = "Mapa_General";
$nonAdminTablesArr[] = "Mapa_ctos";
$nonAdminTablesArr[] = "Mapa Puertos Libres";
$nonAdminTablesArr[] = "Mapa Ventas";
$nonAdminTablesArr[] = "Puertos_Libres";
...
$wGroupTableName = $ug_connection->addTableWrappers( "isp_eisa prueba de mapasuggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "isp_eisa prueba de mapasugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "isp_eisa prueba de mapasugrights" );
