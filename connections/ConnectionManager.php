...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connName"] = "isp_eisa at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;isp_eisa;;1"; //currently unused

		$this->_connectionsIdByName["isp_eisa at localhost"] = "isp_eisa_at_localhost";
