...
require_once("include/endpoint_localidades_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "endpoint_localidades" );
