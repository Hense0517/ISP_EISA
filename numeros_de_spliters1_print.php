...
require_once("include/numeros_de_spliters1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "numeros_de_spliters" );
