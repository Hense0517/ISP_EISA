...
require_once("include/consultar_clientes_por_puerto_olt_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Consultar_clientes_por_puerto_olt" );
