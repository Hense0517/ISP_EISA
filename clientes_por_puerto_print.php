...
require_once("include/clientes_por_puerto_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Clientes_por_puerto" );
