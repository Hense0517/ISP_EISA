...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("numeros_de_cables" == $this->chrt_array['tables'][0])
			return true;
		if("numeros_de_spliters" == $this->chrt_array['tables'][0])
			return true;
		if("ctos" == $this->chrt_array['tables'][0])
			return true;
		if("localidad" == $this->chrt_array['tables'][0])
			return true;
		if("cables" == $this->chrt_array['tables'][0])
			return true;
		if("spliters" == $this->chrt_array['tables'][0])
			return true;
		if("numeros_cto" == $this->chrt_array['tables'][0])
			return true;
		if("numero_puertos" == $this->chrt_array['tables'][0])
			return true;
